...
//
//         protected Dictionary<ReanimatorGraphNode, List<ReanimatorPort>> compatiblePorts = new Dictionary<ReanimatorGraphNode, List<ReanimatorPort>>();
...
//             {
//                 var pv = ghostEdge.input as ReanimatorPort;
...
//             compatiblePorts.Clear();
//
//             foreach (ReanimatorPort port in graphView.GetCompatiblePorts(draggedPort, nodeAdapter))
//             {
//                 compatiblePorts.TryGetValue(port.owner, out var portList);
//                 if (portList == null)
//                     portList = compatiblePorts[port.owner] = new List<ReanimatorPort>();
//                 portList.Add(port);
//             }
//
...
//         }
//
//         protected virtual ReanimatorEdge CreateEdgeView()
//         {
...
//         }
//
//         Rect GetPortBounds(ReanimatorGraphNode nodeView, int index, List<ReanimatorPort> portList)
//         {
