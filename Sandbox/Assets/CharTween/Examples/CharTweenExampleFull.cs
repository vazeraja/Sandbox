...
namespace CharTweener.Assets.CharTween.Examples
{
    public class CharTweenExampleFull : MonoBehaviour
    {
        public TMP_Text Target;
        private global::CharTweener.Assets.CharTween.Scripts.CharTweener _tweener;

        [Header("Tween 1")]
        public float radius = 1;
        [FormerlySerializedAs("strength")] [Header("Tween 2")]
        ...
        private void Tween2(int start, int end)
        {
            ...
            {
                var timeOffset = Mathf.Lerp(0, 1, (i - start) / (float)(end - start + 1));
                _tweener.DOShakePosition(i, 1, strength, vibrato, randomness, false, false)
                    .SetLoops(-1, LoopType.Restart);
